...
public class GamePanel extends JPanel implements Runnable {
    ...
    public static boolean isEasyBoolean() {
        return easyBoolean;
    }

    public static void setEasyBoolean(boolean easyBoolean) {
        GamePanel.easyBoolean = easyBoolean;
    }

    public static boolean isMediumBoolean() {
        return mediumBoolean;
    }

    public static void setMediumBoolean(boolean mediumBoolean) {
        GamePanel.mediumBoolean = mediumBoolean;
    }

    public static boolean isHardBoolean() {
        return hardBoolean;
    }

    public static void setHardBoolean(boolean hardBoolean) {
        GamePanel.hardBoolean = hardBoolean;
    }

    public static boolean easyBoolean, mediumBoolean, hardBoolean;
